...
variable "enable_curv2" {
  description = "Indicates if the CURV2 should be enabled in data exports"
  type        = bool
  default     = true
}
...
variable "enable_focus" {
  description = "Indicates if the FOCUS should be enabled in data exports"
  type        = bool
  default     = false
}
...
variable "enable_scad" {
  description = "Indicates if the SCAD should be enabled in data exports"
  type        = bool
  default     = false
}
